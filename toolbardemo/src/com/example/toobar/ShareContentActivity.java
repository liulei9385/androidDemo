...
import com.example.toobar.content.ContentItem;
 ...
 * TIME: 13:50
 */
public class ShareContentActivity extends ActionBarActivity {
    ...
    private final PagerAdapter mPagerAdapter = new PagerAdapter() {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (mInflater == null) {
                mInflater = LayoutInflater.from(ShareContentActivity.this);
            }
    ...
    private void setShareIntent(int position) {
        ...
        if (mShareActionProvider != null) {
            ...
            Intent shareIntent = item.getShareIntent(ShareContentActivity.this);
